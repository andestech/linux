...
/* Device base address */
#define DMAC_BASE			((unsigned long)pdata->dmac_regs)
 ...
 *   If controller properties are embedded in this union, request for a channel
...
typedef struct dmad_chreq {
	 ...
	 *    src/dst addressing
	 *  - ring_size should >= periods * period_size
	 */
